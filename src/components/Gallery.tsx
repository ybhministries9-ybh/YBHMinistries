...
function _formatVideoDate(dateStr: string): string {
...
// Note: VideoCard and ImageCard UI were extracted to separate memoized components
// `src/components/gallery/VideoCard.tsx` and `src/components/gallery/ImageCard.tsx`
...
export function Gallery() {
  ...
  const _currentTab = useMemo(() => TAB_CONFIG.find((tab) => tab.key === activeTab), [activeTab]);
