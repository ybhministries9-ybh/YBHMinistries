...
export const sampleMinistries = [
  {
    ...
    programs: ['Beginner Piano', 'Advanced Guitar', 'Vocal Training', 'Worship Leadership', 'Music Theory'],
  ...
  },
  {
    ...
    programs: ['Sunday Worship', 'Wednesday Night Worship', 'Special Events', 'Worship Team Training'],
  ...
  },
  {
    ...
    programs: ['Sunday School', 'Midweek Bible Study', 'Small Groups', 'New Believers Class'],
  ...
  },
  {
    ...
    programs: ['Morning Prayer', 'Prayer Chain', 'Community Outreach', 'Fellowship Dinners'],
...
export const sampleBibleStudies = [
  {
    id: '1',
...
export const sampleDevotionals = [
  {
    id: '1',
