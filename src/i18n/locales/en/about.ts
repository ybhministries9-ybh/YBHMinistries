export default {
  ...
  vision: {
    ...
    intro1_highlight: "Yeshua Beth Hallel Ministries envisions a world where worship knows no boundaries.",
    ...
    outro: "Ultimately, we dream of a world where every believer becomes a worshiper, every home becomes a sanctuary, and every church becomes a training ground for spiritual transformation.",
    outro_highlights: [
      'every believer becomes a worshiper',
      'every home becomes a sanctuary',
      'every church becomes a training ground'
    ]
  },
  mission: {
    title: "Our Mission",
  ...
  commitment: {
    ...
    description_highlight: 'movement',
    quote_highlight: 'hearts are healed, lives are restored, and nations are changed.'
  },
  coreValues: {
    ...
    subtitle_highlight: 'Yeshua Beth Hallel Ministries',
    love: {
      title: "Love",
  ...
  beliefSystem: {
    ...
    trinity_lead: "We believe in the Holy Trinity",
    ...
    denominations_lead: "We honor and respect every Christian denomination",
  ...
  movementBeyondWalls: {
    ...
    callToAction_highlight: 'transcending boundaries and embracing a world where worship knows no limits'
  }
};
