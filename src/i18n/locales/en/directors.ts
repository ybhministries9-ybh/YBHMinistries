export default {
  ...
  vijaya: {
    ...
    aboutSection: {
      ...
      visionMissionTitle: "Vision & Mission",
      paragraph1: "Pastor Vijaya Kumari Dandingi is a powerful woman of prayer and wife of Ps. Augustine Dandingi.",
      paragraph2: "A woman behind the success of this ministry. A strong supporter and wise homemaker. She received salvation through UESI and completed training with YWAM. ",
      paragraph3: "She is a true prayer warrior. She has fully supported Augustine’s ministry, taking complete responsibility for the children, their education, and their spiritual growth. The success of this ministry is a result of teamwork. She leads daily family worship at home.",
      paragraph4: "She has traveled many kilometers for the sake of her children’s upbringing. Today, her children are blessed and are a great support to the ministry.",
        ministryHighlights: "Ministry Highlights",
  ...
  charles: {
    ...
    aboutSection: {
      ...
      visionMissionTitle: "Vision & Mission",
      paragraph1: "A well-experienced Guitar Teacher. From a young age, under the guidance of his father Augustine, he was trained by highly skilled guitar teachers and well-known worship leaders who taught him worship dynamics and how to lead worship while playing the guitar. Through the University of West London, he completed 6 Grades and was shaped into a well-qualified teacher. Along with this, from the age of 16, he developed the habit of teaching others what he learned. He also worked as a guitarist for various worship bands.",
      paragraph2: "Because of his experience, at just 18 years of age, he was selected as a teacher in the well-known online school \"WhiteHat Jr\" and earned recognition as one of their best teachers.",
      paragraph3: "At present, he has been leading the Guitar Department at HALLEL MUSIC SCHOOL. Over the past 5 years, he has trained more than 1,200 students worldwide through both online and offline classes. Starting in 2025, he is also preparing students for recognized grade exams such as LCM and TRINITY.",
      ministryHighlights: "Ministry Highlights",
  ...
  nancy: {
    ...
    aboutSection: {
      ...
      visionMissionTitle: "Vision & Mission",
      paragraph1: "A well-experienced Piano, Keyboard, and Vocals teacher. From her early childhood, her father Augustine recognized her talent and personally trained her while also arranging training with highly skilled music teachers. She completed LCM Grade 6 in Piano/Keyboard and LCM Grade 5 in Vocals. She is currently being developed into a strong worship leader.",
      paragraph2: "Nancy is now in the final year of her degree. After she joined St. Mary’s Stella College for Intermediate, the college management quickly noticed her talent in singing and playing the keyboard. They gave her multiple opportunities to perform in various college events. With that encouragement, she formed a band with her friends in the same college and performed at many programs, receiving appreciation and recognition from the college management. The college magazine even dedicated a special page to her, publishing a wonderful article about her musical journey.",
      paragraph3: "Currently, she is continuing her studies while also training many students to become skilled musicians. In 2025, she trained and sent 90 students for the LCM Grade Exams, ensuring they passed with First Class results.",
      ministryHighlights: "Ministry Highlights",
