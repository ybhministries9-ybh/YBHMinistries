export default {
  ...
  augustine: {
    ...
    aboutSection: {
      ...
      paragraph1: "పాస్టర్ అగస్టిన్ దండింగి ఒక చురుకైన ఆత్మీయ నాయకుడు, అభిషిక్త ఆరాధకుడు, అలాగే దూరదృష్టి గల వ్యవస్థాపకుడు. ఆయన యెషువా బెత్ హల్లెల్ మినిస్ట్రీస్ (YBHM) మరియు హల్లెల్ మ్యూజిక్ స్కూల్ (HMS) స్థాపకులు. ఈ సేవాసంస్థల ప్రధాన కార్యాలయం భారతదేశంలోని విజయవాడలో ఉంది. ఈ పరిచర్యల ద్వారా, అతను అనేక దేశాలలో నిజమైన ఆరాధకుల తరాన్ని లేపాలనే దైవిక దర్శనాన్ని ఆయన ఉత్సాహంగా నెరవేర్చుతున్నారు.",
      paragraph2: "\"భారతదేశంలోని ప్రతి సంఘము సంగీత వాద్యములతో ఆరాధించాలి, ప్రతి ఇల్లు ఆరాధన మందిరముగా మారాలి\" అనే దేవుడు ఇచ్చిన పిలుపుతో ప్రేరేపించబడి, పాస్టర్ అగస్టిన్ ప్రతి విశ్వాసిని ఆరాధకునిగా తీర్చిదిద్దాలనే లక్ష్యంతో ఉచిత ఆన్‌లైన్ కీబోర్డ్ శిక్షణను అందించే హల్లెల్ మ్యూజిక్ స్కూల్‌ను ప్రారంభించారు.",
      paragraph3: "తన అంకితభావంతో పనిచేసిన బృందంతో కలిసి, 2,425 మంది విద్యార్థులు విజయవంతంగా గిన్నిస్ వరల్డ్ రికార్డ్స్ సర్టిఫికెట్లు సాధించేందుకు ఆయన ముఖ్యమైన పాత్ర పోషించారు.",
      ...
      shofarInstructorTitle: "కొమ్ము బోధకుడు",
      shofarInstructorDesc: "బైబిల్ వాద్యం \"కొమ్ము\" బోధించే భారతదేశంలోని కొద్దిమంది బోధకులలో ఒకరు"
    },
    ...
    ministriesVisionSection: {
      ...
      hms: {
        ...
        studentsTrained: "10,000+ విద్యార్థులకు శిక్షణ",
        description: "ప్రతి విశ్వాసిని ఆరాధకునిగా చేయాలనే లక్ష్యంతో ఉచిత ఆన్‌లైన్ కీబోర్డ్ శిక్షణను అందిస్తోంది. కేవలం నాలుగు సంవత్సరాలలో, ఈ చొరవ ద్వారా 10,000 కంటే ఎక్కువ విద్యార్థులకు శిక్షణ ఇవ్వబడింది, ఇది గిన్నిస్ వరల్డ్ రికార్డ్ సాధనలో ముగిసింది.",
        tags: {
    ...
    hallelTab: {
      ...
      point2: "కేవలం నాలుగు సంవత్సరాలలో 10,000+ విద్యార్థులకు శిక్షణ",
      ...
      worldRecordDesc: "డిసెంబర్ 1, 2024న, పాస్టర్ అగస్టిన్ 1,046 మంది విద్యార్థులను ఆన్‌లైన్‌లో ఏకకాలంలో కీబోర్డ్ వాయించడానికి నాయకత్వం వహించడం ద్వారా గిన్నిస్ వరల్డ్ రికార్డ్ సృష్టించారు—ప్రపంచ ఆరాధన మరియు సంగీత విద్యా రంగంలో ఒక ముఖ్యమైన గుర్తును సృష్టించారు.",
      guinnessRecord: "గిన్నిస్ వరల్డ్ రికార్డ్",
      keyboardPlayers: "1,046 కీబోర్డ్ ప్లేయర్లు",
      internationalRecognition: "అంతర్జాతీయ గుర్తింపు",
      multipleRecords: "బహుళ వరల్డ్ రికార్డ్స్",
      globalImpact: "ప్రపంచ ప్రభావం"
    },
      teachingSection: {
        shofarTitle: "కొమ్ము బోధన",
        shofarDesc: "పాస్టర్ అగస్టిన్ భారతదేశంలో కొమ్ము‌ను బోధించే అరుదైన బోధకులలో ఒకరు, మరియు ఆధ్యాత్మిక మరియు ప్రవక్తాత్మక ప్రాముఖ్యాన్ని పునరుజ్జీవింపచేయడంలో ప్రముఖ వాణిగా పరిణమించారు.",
        shofarPoint1: { title: "బైబుల్ ఆధారాలు", desc: "కొమ్ము యొక్క చారిత్రక మరియు బైబిల్ ప్రాముఖ్యతను బోధించడం" },
        shofarPoint2: { title: "సాంకేతికత & సాధన", desc: "వాయించుటకు అవసరమైన సాంకేతిక నైపుణ్యాలు మరియు శబ్ద ఉత్పత్తిపై ప్రాక్టికల్ బోధన" },
        shofarPoint3: { title: "భవిష్య వాణి అన్వయము", desc: "ఆరాధనలో కొమ్ము యొక్క ప్రవక్తాత్మక పరిమాణాన్ని అర్ధం చేసుకోవడం" },
