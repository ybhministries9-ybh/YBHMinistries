export default {
  meta: {
    title: "వార్తలు & నవీకరణలు | YBH మినిస్ట్రీస్",
    description: "యేషూవా బేత్ హలేల్ మినిస్ట్రీస్ నుండి తాజా వార్తలు, ప్రకటనలు మరియు ఈవెంట్‌లతో నవీకరించబడండి. మా ఇటీవలి కార్యకలాపాలు మరియు రాబోయే కార్యక్రమాల గురించి చదవండి."
  },
