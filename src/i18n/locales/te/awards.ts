export default {
  meta: {
    ...
    description: "శ్రేష్ఠతను జరుపుకోవడం మరియు మంత్రిత్వంలో అత్యుత్తమ విజయాలను గుర్తించడం. YBH మినిస్ట్రీస్ మరియు హలేల్ ఆరాధన సమాజం అందుకున్న అవార్డులు, గౌరవాలు మరియు గుర్తింపులను చూడండి."
  },
  "title": "అవార్డులు",
