export default {
  ...
  mission: {
    ...
    evangelize: {
      ...
      description: "యేసు క్రీస్తు గురించి శుభవార్తను తెలియజేస్తూ, కేవలం మాటలతో కాకుండా, ప్రేమతో, జీవితం మరియు సాక్ష్యం ద్వారా చూపిస్తాము. ప్రతి వ్యక్తి దేవుని ప్రేమను అనుభవించేలా నడిపిస్తాము. వారి జీవితంలో మార్పు కలిగేలా, దేవునితో వ్యక్తిగత సంబంధం ఏర్పడేలా సహాయం చేస్తాము.",
      description_highlight: 'రక్షణ, ఆశ మరియు ప్రేమ'
    },
    educate: {
      title: "2. విద్యాబోధన",
      description: "ప్రతి వ్యక్తి జీవితములో మార్పు తీసుకువచ్చే  పరిచర్య. రక్షణ పొందిన వ్యక్తులు క్రైస్తవ విలువలతో జీవించుటకు ఆధ్యాత్మిక జీవితాన్ని నేర్పిస్తూ, వారి ప్రవర్తనలో, గుణాలలో మార్పులు తీసుకుని వచ్చి, ఆత్మ సంబంధమైన వ్యక్తులుగా మారుస్తాము. ప్రతి ఒక్కరిలో దేవుడు ఉంచిన సహజ సామర్థ్యాలను గుర్తించి, వారికి అవగాహన కలిగిస్తాము. ఆ టాలెంట్స్‌ను మెరుగుపరచి, ఉపయోగకరమైన స్కిల్స్‌గా మార్చుతాము. ఈ ప్రక్రియ ద్వారా వారు తమ జీవితంలో నిలబడటమే కాకుండా, సమాజానికి సేవ చేసే వ్యక్తులుగా మార్చి, సమాజంలో మార్పు తీసుకొచ్చే నాయకులుగా మారుస్తాము.",
      description_highlight: 'ఆరాధన యొక్క కళ మరియు హృదయంలో'
    },
    execute: {
      title: "3. అమలు",
      description: "ఈ పరిచర్యలో తర్ఫీదు పొందిన వ్యక్తులను ఒంటరిగా వదిలిపెట్టము. వారికి నిరంతర సహాయం, స్పష్టమైన మార్గదర్శకత్వం, మరియు ప్రోత్సాహం అందిస్తూ, వారు నేర్చుకున్న విషయాలను జీవితంలో ధైర్యంగా అమలు చేయగలిగేలా తోడ్పడతాము. వారి లోపలి బలాలను గుర్తించి, వాటిని మరింతగా అభివృద్ధి చేస్తూ, ఆచరణలో పెట్టేందుకు ప్రేరేపిస్తాము. ఈ విధంగా వారు స్వయంప్రతిపత్తి కలిగిన, స్థిరమైన వ్యక్తులుగా ఎదగడానికి సహాయం చేస్తాము. మా లక్ష్యం కేవలం శిక్షణ ఇవ్వడం మాత్రమే కాదు; వారు పూర్తిగా స్థిరపడే వరకు వారికి అండగా నిలబడి, జీవితంలో ధైర్యంగా ముందుకు సాగుతూ, సమాజంపై సానుకూల ప్రభావం చూపగల నాయకులుగా తీర్చిదిద్దడం.",
