export default {
  meta: {
    title: "ఫోటో గ్యాలరీ | YBH మినిస్ట్రీస్",
    description: "YBH మినిస్ట్రీస్ ఈవెంట్‌లు, ఆరాధన సేవలు, సమావేశాలు మరియు మినిస్ట్రీ కార్యకలాపాల నుండి ఫోటోలను బ్రౌజ్ చేయండి. మా సమాజం చర్యలో చూడండి."
  },
  title: "గ్యాలరీ",
