export default {
  meta: {
    title: "మమ్మల్ని సంప్రదించండి | YBH మినిస్ట్రీస్",
    description: "యేషూవా బేత్ హలేల్ మినిస్ట్రీస్‌తో సంప్రదించండి. మా బైబిల్ కాలేజీ, మ్యూజిక్ స్కూల్, చర్చి సేవలు లేదా మినిస్ట్రీ కార్యక్రమాల గురించి విచారణలకు మమ్మల్ని సంప్రదించండి."
  },
  ...
  hero: {
    ...
    bookingSuccessMessage:
      "మీ స్లాట్ బుక్ చేసినందుకు ధన్యవాదాలు. మేము మీ అభ్యర్థనను సమీక్షించి, త్వరలో మీకు తిరిగి స్పందిస్తాము.",
    bookAnother: 'మరొకటి బుక్ చేయండి'
  },

  contactForm: {
    title: "మాతో సంప్రదించండి",
    subtitle: "మాకు సందేశం పంపండి, మేము మీకు తిరిగి స్పందిస్తాము.",
    name: "పూర్తి పేరు",
    phone: "ఫోన్ నంబర్",
    email: "ఇమెయిల్ ID",
    location: "స్థానం",
    ...
    success: "ధన్యవాదాలు! మమ్మల్ని సంప్రదించినందుకు. మేము త్వరలో మీకు తిరిగి స్పందిస్తాము.",
    ...
    validation: {
      ...
      emailMax: 'గరిష్టం 254 అక్షరాలు అనుమతించబడతాయి.',
      phoneRequired: 'ఫోన్ నంబర్ అవసరం.',
      phoneMin: 'దయచేసి ఫోన్ నంబర్‌కు కనీసం 10 అంకెలు నమోదు చేయండి.',
      phoneInvalid: 'దయచేసి చెల్లుబాటు అయ్యే ఫోన్ నంబర్‌ను నమోదు చేయండి.',
      phoneMax: 'ఫోన్ నంబర్‌కు గరిష్టం 15 అక్షరాలు అనుమతించబడతాయి.',
  ...
  studentForm: {
    ...
    options: {
      ...
      rapidCourse: "నేను రాపిడ్ కోర్సుతో వృత్తిపరమైన సంగీతం నేర్చుకోవాలనుకుంటున్నాను, ఏప్రిల్ నుండి మే (చెల్లించాల్సింది)",
    ...
    buttons: {
      ...
      ,
      submitAnother: "మరో దరఖాస్తును సమర్పించండి"
    },
    messages: {
