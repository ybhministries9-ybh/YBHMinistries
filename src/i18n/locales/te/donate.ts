export default {
  meta: {
    title: "విరాళం & మద్దతు | YBH మినిస్ట్రీస్",
    description: "యేషూవా బేత్ హలేల్ మినిస్ట్రీస్ మిషన్‌కు మద్దతు ఇవ్వండి. మీ విరాళాలు ఆరాధన, విద్య మరియు మినిస్ట్రీ కార్యక్రమాలను కొనసాగించడంలో మాకు సహాయపడతాయి."
  },
  ...
  paymentMethods: {
    ...
    qr: {
      ...
      enlargeHint: "QR కోడ్‌ను పెద్దగా చూడటానికి తాకండి",
      enlargeTitle: "పూర్తి తెరలో చూడటానికి క్లిక్ చేయండి",
      noQrTitle: "QR కోడ్ అందుబాటులో లేదు",
      noQrDescription: "ప్రస్తుతానికి మా వద్ద ప్రజలకు అందుబాటులో ఉన్న UPI QR కోడ్‌లు లేవు. బదిలీ సమాచారానికి దయచేసి బ్యాంక్ వివరాలను పరీక్షించండి లేదా మళ్ళీ ప్రయత్నించండి.",
      upiIdLabel: "UPI ID"
    }
  },
  ...
  ,
    swift: "SWIFT కోడ్",
    note: "దయచేసి లెన్దేన్స్ రిఫరెన్సులో మీ పేరు మరియు సంప్రదింపు వివరాలను చేర్చండి"
  }
  ,
  fullscreen: {
    closeHint: "మూసటానికి ఎక్కడైనా తాకండి"
  }
};
