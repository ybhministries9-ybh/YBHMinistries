...
async function main() {
  ...
  console.log('Creating user:', target);
  ...
  console.log('User created id', id, '- sending invite');
  ...
  if (inviteJson?.providerResponse) console.log('Provider response body:', inviteJson.providerResponse);
  process.exit(0);
}
